<script lang="ts">
	...
	async function handleSubmit() {
		...
		try {
			...
			error = err?.message || 'Failed to create team member. Please try again.';
		} finally {
			loading = false;
		}
	}
...
<Dialog {open} title="Add Team Member" on:close={handleClose}>
	<form on:submit|preventDefault={handleSubmit} class="space-y-4">
		...
		<div class="space-y-2">
			<Label htmlFor="retypePassword" className="text-gray-700">Retype Password</Label>
			<Input
				id="retypePassword"
				type="password"
